...
window.N8N_DATA = (function(){
  ...
  var LIBRARY = [
    ...
    {c:'n8n', t:'n8n Docs: Webhook node', url:'https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.webhook/', type:'توثيق رسمي', lang:'EN', lvl:'مبتدئ', days:[1],
     why:'الفرق بين Test URL وProduction URL، وطرق الرد، والمصادقة على الـ Webhook.', read:'Node parameters و Webhook URLs و Respond.'},
    {c:'n8n', t:'n8n Docs: Built-in methods and variables', url:'https://docs.n8n.io/code/builtin/overview/', type:'توثيق رسمي', lang:'EN', lvl:'مبتدئ → متوسط', days:[1,4],
     why:'كل المتغيرات الجاهزة زي $json و$input و$node و$execution و$vars في مكان واحد.', read:'Current node input و Output of other nodes و Date and time.'},
    {c:'n8n', t:'n8n Docs: Splitting with conditionals', url:'https://docs.n8n.io/flow-logic/splitting/', type:'توثيق رسمي', lang:'EN', lvl:'مبتدئ', days:[2],
     why:'إمتى تستخدم IF وإمتى Switch، وإزاي الـ items بتتوزع على المسارات.', read:'الصفحة كلها (10 دقايق).'},
    {c:'n8n', t:'n8n Docs: Merging data', url:'https://docs.n8n.io/flow-logic/merging/', type:'توثيق رسمي', lang:'EN', lvl:'متوسط', days:[2],
     why:'أوضاع Merge كلها: Append وCombine by fields وBy position وSQL Query.', read:'الصفحة كلها، وجرّب كل وضع على بيانات صغيرة.'},
    {c:'n8n', t:'n8n Docs: Credentials', url:'https://docs.n8n.io/credentials/', type:'توثيق رسمي', lang:'EN', lvl:'مبتدئ', days:[3],
     why:'إزاي تضيف وتشارك وتحمي الـ Credentials، ومصادقة HTTP العامة.', read:'Add and edit credentials و Credential sharing.'},
    {c:'n8n', t:'n8n Docs: Google Sheets node', url:'https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.googlesheets/', type:'توثيق رسمي', lang:'EN', lvl:'مبتدئ', days:[3],
     why:'كل عمليات الشيت: Get وAppend وUpdate وAppend or Update وDelete.', read:'Operations و Common issues.'},
    {c:'n8n', t:'n8n Docs: Telegram node', url:'https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.telegram/', type:'توثيق رسمي', lang:'EN', lvl:'مبتدئ', days:[3],
     why:'إرسال الرسايل والصور والأزرار، والمشاكل الشائعة مع الـ Trigger.', read:'Message operations و Common issues.'},
    {c:'n8n', t:'n8n Docs: Gmail node', url:'https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.gmail/', type:'توثيق رسمي', lang:'EN', lvl:'مبتدئ', days:[3],
     why:'إرسال وقراءة الإيميلات والـ Labels والـ Drafts.', read:'Message operations.'},
    {c:'n8n', t:'n8n Docs: AI Agent node', url:'https://docs.n8n.io/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.agent/', type:'توثيق رسمي', lang:'EN', lvl:'متوسط', days:[6],
     why:'إعدادات الـ Agent: System Message والأدوات والـ Memory والـ Output Parser.', read:'Node parameters و Common issues.'},
    {c:'n8n', t:'n8n Docs: Securing n8n', url:'https://docs.n8n.io/hosting/securing/overview/', type:'توثيق رسمي', lang:'EN', lvl:'متقدم', days:[7],
     why:'SSL والمصادقة وقفل الحاجات اللي مش محتاجها قبل ما تفتح n8n على الإنترنت.', read:'Set up SSL و Disable the API و Security audit.'},
    {c:'n8n', t:'n8n Public API', url:'https://docs.n8n.io/api/', type:'توثيق رسمي', lang:'EN', lvl:'متقدم', days:[7],
     why:'تتحكم في n8n نفسه بالكود: تجيب الـ Workflows وتشغلها وتعمل Backup.', read:'Authentication و API reference.'},
    {c:'n8n', t:'n8n Docs: Keyboard shortcuts', url:'https://docs.n8n.io/keyboard-shortcuts/', type:'توثيق رسمي', lang:'EN', lvl:'مبتدئ', days:[1],
     why:'اختصارات الكيبورد اللي بتسرّع شغلك في المحرر.', read:'اطبعها أو احفظ أول 10.'},
    {c:'n8n', t:'n8n Release notes', url:'https://docs.n8n.io/release-notes/', type:'توثيق رسمي', lang:'EN', lvl:'كل المستويات', days:[],
     why:'n8n بيتحدّث كل أسبوع تقريبًا. هنا تعرف إيه اللي اتغير قبل ما تحدّث.', read:'اقرا ملخص آخر إصدار قبل أي تحديث للسيرفر.'},
    {c:'n8n', t:'n8n Blog', url:'https://blog.n8n.io/', type:'مقالات', lang:'EN', lvl:'كل المستويات', days:[],
     why:'دروس وحالات استخدام حقيقية من فريق n8n.', read:'مقال في الأسبوع في موضوع بتتعلمه.'},
    {c:'n8n', t:'n8n YouTube', url:'https://www.youtube.com/@n8n-io', type:'فيديوهات', lang:'EN', lvl:'كل المستويات', days:[],
     why:'القناة الرسمية: كورسات مبتدئين ومتقدمين وشرح المميزات الجديدة.', read:'قايمة Beginner Course الأول.'},
    {c:'n8n', t:'n8n on GitHub', url:'https://github.com/n8n-io/n8n', type:'كود مفتوح', lang:'EN', lvl:'متقدم', days:[],
     why:'كود n8n نفسه، والـ Issues اللي فيها حلول لمشاكل كتير.', read:'دوّر في Issues على رسالة الخطأ لو المنتدى مفيهوش حل.'},
    {c:'n8n', t:'Self-hosted AI Starter Kit', url:'https://github.com/n8n-io/self-hosted-ai-starter-kit', type:'قالب جاهز', lang:'EN', lvl:'متقدم', days:[],
     why:'Docker Compose رسمي فيه n8n وموديل AI محلي وقاعدة Vector، كله على جهازك.', read:'README وجرّبه بعد ما تخلص أسبوع Docker.'},
    ...
    {c:'JavaScript', t:'MDN JavaScript Reference', url:'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference', type:'مرجع رسمي', lang:'EN', lvl:'كل المستويات', days:[4],
     why:'صفحة لكل دالة: Array وString وObject وDate وJSON، بأمثلة تجربها.', read:'Standard built-in objects ← Array و String.'},
    {c:'JavaScript', t:'Luxon Docs', url:'https://moment.github.io/luxon/', type:'توثيق رسمي', lang:'EN', lvl:'متوسط', days:[4],
     why:'مكتبة التواريخ اللي n8n بيستخدمها في $now و$today.', read:'A quick tour و Formatting.'},
    {c:'JavaScript', t:'freeCodeCamp Curriculum', url:'https://www.freecodecamp.org/learn/', type:'كورس تفاعلي مجاني', lang:'EN', lvl:'مبتدئ → متوسط', days:[],
     why:'آلاف التمارين الصغيرة في JavaScript وPython، وشهادات مجانية.', read:'JavaScript Algorithms and Data Structures: جزء Basic JavaScript.'},
    {c:'JavaScript', t:'Exercism: JavaScript', url:'https://exercism.org/tracks/javascript', type:'تمارين مجانية', lang:'EN', lvl:'مبتدئ → متوسط', days:[],
     why:'تمارين بتتصحح لوحدها، وممكن تطلب مراجعة من مرشد متطوع.', read:'تمرين أو اتنين في اليوم بعد الأسبوع المكثّف.'},
    // Python
    ...
    {c:'Python', t:'CS50P: Introduction to Programming with Python', url:'https://cs50.harvard.edu/python/', type:'كورس مجاني', lang:'EN', lvl:'مبتدئ', days:[],
     why:'كورس هارفارد المجاني لـ Python بفيديوهات ومسائل وشهادة مجانية.', read:'محاضرة في الأسبوع مع أسابيع Python في الخطة.'},
    {c:'Python', t:'A Byte of Python', url:'https://python.swaroopch.com/', type:'كتاب مجاني', lang:'EN', lvl:'مبتدئ', days:[],
     why:'كتاب قصير وبسيط جدًا، مناسب لو عايز تخلص الأساسيات بسرعة.', read:'من Basics لحد Data Structures.'},
    {c:'Python', t:'Beyond the Basic Stuff with Python', url:'https://inventwithpython.com/beyond/', type:'كتاب مجاني', lang:'EN', lvl:'متوسط', days:[],
     why:'الخطوة بعد Automate the Boring Stuff: كود نضيف، وأخطاء شائعة، وأدوات.', read:'بعد الـ 12 أسبوع: Code formatting و Common Python gotchas.'},
    {c:'Python', t:'Python Standard Library', url:'https://docs.python.org/3/library/', type:'مرجع رسمي', lang:'EN', lvl:'متوسط', days:[],
     why:'مرجع كل المكتبات اللي جاية مع Python: json وcsv وdatetime وre وpathlib.', read:'json و csv و datetime وقت الحاجة.'},
    {c:'Python', t:'Requests Docs', url:'https://requests.readthedocs.io/', type:'توثيق رسمي', lang:'EN', lvl:'مبتدئ', days:[],
     why:'أشهر مكتبة Python لنداء الـ APIs، نفس اللي بتعمله HTTP Request في n8n.', read:'Quickstart (20 دقيقة).'},
    {c:'Python', t:'Real Python', url:'https://realpython.com/', type:'مقالات', lang:'EN', lvl:'مبتدئ → متقدم', days:[],
     why:'مقالات ودروس Python مفصلة لكل موضوع تقريبًا.', read:'دوّر على الموضوع اللي بتتعلمه (مثلاً: python requests).'},
    {c:'Python', t:'Exercism: Python', url:'https://exercism.org/tracks/python', type:'تمارين مجانية', lang:'EN', lvl:'مبتدئ → متوسط', days:[],
     why:'تمارين Python بتتصحح لوحدها مع مراجعة من مرشدين.', read:'تمرين في اليوم في أسابيع Python.'},
    // Web / HTTP / JSON
    ...
    {c:'HTTP وJSON', t:'MDN: HTTP request methods', url:'https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods', type:'مرجع', lang:'EN', lvl:'مبتدئ', days:[2],
     why:'GET وPOST وPUT وPATCH وDELETE: كل واحد بيعمل إيه.', read:'الصفحة الرئيسية + GET و POST.'},
    {c:'HTTP وJSON', t:'Postman Learning Center', url:'https://learning.postman.com/', type:'توثيق ودروس', lang:'EN', lvl:'مبتدئ → متوسط', days:[2],
     why:'تجرّب أي API قبل ما تبنيه في n8n، وتفهم المصادقة والـ Headers.', read:'Getting started ← Sending your first request.'},
    {c:'HTTP وJSON', t:'Everything curl', url:'https://everything.curl.dev/', type:'كتاب مجاني', lang:'EN', lvl:'متوسط', days:[2],
     why:'الكتاب الرسمي لـ curl من صاحبه. مفيد لأن n8n بيستورد أوامر cURL.', read:'HTTP with curl ← Method و Post و Headers.'},
    {c:'HTTP وJSON', t:'JSONPlaceholder', url:'https://jsonplaceholder.typicode.com/', type:'API تجريبي', lang:'EN', lvl:'مبتدئ', days:[2],
     why:'API مجاني ببيانات وهمية تتدرب عليه من غير تسجيل.', read:'Resources و Routes: جرّب كل واحد في HTTP Request.'},
    {c:'HTTP وJSON', t:'httpbin', url:'https://httpbin.org/', type:'API تجريبي', lang:'EN', lvl:'مبتدئ', days:[2,5],
     why:'بيرجعلك الطلب اللي بعته زي ما هو، وبيطلّع أي status code تطلبه عشان تجرّب الأخطاء.', read:'/anything و /status/500 و /delay/5.'},
    {c:'HTTP وJSON', t:'Webhook.site', url:'https://webhook.site/', type:'أداة', lang:'EN', lvl:'مبتدئ', days:[1],
     why:'رابط مؤقت يستقبل أي طلب ويوريك محتواه. ممتاز تختبر بيه اللي n8n بيبعته.', read:'افتحه وابعتله من HTTP Request وشوف الـ Body والـ Headers.'},
    {c:'HTTP وJSON', t:'Public APIs', url:'https://github.com/public-apis/public-apis', type:'قايمة مجانية', lang:'EN', lvl:'كل المستويات', days:[2],
     why:'مئات الـ APIs المجانية مقسمة حسب الموضوع، عشان تلاقي بيانات لمشاريعك.', read:'اختار API من غير Auth وابني عليه Workflow.'},
    {c:'HTTP وJSON', t:'JSONLint', url:'https://jsonlint.com/', type:'أداة', lang:'EN', lvl:'مبتدئ', days:[1],
     why:'بيقولك فين الغلط بالظبط في JSON.', read:'الصق أي JSON مش شغال وشوف السطر اللي فيه المشكلة.'},
    // SQL
    ...
    {c:'SQL', t:'SQLZoo', url:'https://sqlzoo.net/', type:'دروس تفاعلية', lang:'EN', lvl:'مبتدئ → متوسط', days:[],
     why:'تمارين SQL متدرجة على بيانات حقيقية، وفيه JOIN كتير.', read:'SELECT basics لحد JOIN.'},
    {c:'SQL', t:'PostgreSQL Exercises', url:'https://pgexercises.com/', type:'تمارين مجانية', lang:'EN', lvl:'متوسط', days:[],
     why:'تمارين على Postgres بالظبط، من البسيط للـ Aggregates والـ Window functions.', read:'Simple SQL Queries ← Joins ← Aggregation.'},
    // Git / Linux
    ...
    {c:'Git وLinux', t:'GitHub Skills', url:'https://skills.github.com/', type:'كورسات تفاعلية مجانية', lang:'EN', lvl:'مبتدئ', days:[],
     why:'كورسات GitHub الرسمية جوه repo حقيقي: أول repo وPull Request وMarkdown وGitHub Pages.', read:'Introduction to GitHub ← Communicate using Markdown.'},
    {c:'Git وLinux', t:'GitHub Docs: Get started', url:'https://docs.github.com/en/get-started', type:'توثيق رسمي', lang:'EN', lvl:'مبتدئ', days:[],
     why:'التوثيق الرسمي لـ GitHub: الحساب والـ repos والمصادقة.', read:'Quickstart ← Hello World.'},
    {c:'Git وLinux', t:'Oh Shit, Git!?!', url:'https://ohshitgit.com/', type:'دليل', lang:'EN', lvl:'مبتدئ', days:[],
     why:'حلول سريعة لأشهر الغلطات في Git (commit غلط، branch غلط، وهكذا).', read:'اقراها مرة، وارجعلها وقت المشكلة.'},
    {c:'Git وLinux', t:'PowerShell 101 (Microsoft Learn)', url:'https://learn.microsoft.com/en-us/powershell/scripting/learn/ps101/00-introduction', type:'كتاب رسمي مجاني', lang:'EN', lvl:'مبتدئ', days:[],
     why:'كتاب Microsoft الرسمي لـ PowerShell، الطرفية اللي على ويندوز.', read:'الفصول 1–3.'},
    {c:'Git وLinux', t:'Linux Journey', url:'https://linuxjourney.com/', type:'دروس مجانية', lang:'EN', lvl:'مبتدئ', days:[7],
     why:'دروس لينكس قصيرة ومرتبة بتمارين.', read:'Grasshopper: Command Line و Text-Fu.'},
    {c:'Git وLinux', t:'explainshell', url:'https://explainshell.com/', type:'أداة', lang:'EN', lvl:'مبتدئ', days:[7],
     why:'تلصق أي أمر لينكس وبيشرحلك كل جزء فيه.', read:'جرّب فيه أي أمر Docker أو لينكس قبل ما تشغله على السيرفر.'},
    // Docker
    ...
    {c:'Docker', t:'Docker Compose Docs', url:'https://docs.docker.com/compose/', type:'توثيق رسمي', lang:'EN', lvl:'متوسط', days:[7],
     why:'ملف docker-compose.yml بالتفصيل: services وvolumes وnetworks وenv.', read:'How Compose works و Quickstart.'},
    {c:'Docker', t:'Play with Docker', url:'https://labs.play-with-docker.com/', type:'معمل أونلاين', lang:'EN', lvl:'مبتدئ', days:[7],
     why:'سيرفر Docker مجاني في المتصفح لمدة 4 ساعات، تجرّب من غير ما تثبّت حاجة.', read:'اعمل Instance وشغّل n8n بأمر docker run.'},
    {c:'Docker', t:'Caddy Docs', url:'https://caddyserver.com/docs/', type:'توثيق رسمي', lang:'EN', lvl:'متوسط', days:[7],
     why:'أسهل Reverse Proxy بيعمل HTTPS لوحده قدّام n8n على الـ VPS.', read:'Getting Started ← Reverse proxy quick-start.'},
    // Regex
    ...
    {c:'Regex', t:'MDN: Regular expressions', url:'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_expressions', type:'توثيق', lang:'EN', lvl:'مبتدئ → متوسط', days:[4],
     why:'Regex في JavaScript بالظبط، نفس اللي بتكتبه في Code node والـ Expressions.', read:'Writing a regular expression pattern و Using regular expressions.'},
    {c:'Regex', t:'Python Regex HOWTO', url:'https://docs.python.org/3/howto/regex.html', type:'توثيق رسمي', lang:'EN', lvl:'متوسط', days:[],
     why:'Regex في Python بمكتبة re.', read:'Simple Patterns و Using Regular Expressions.'},
    // AI
    ...
    {c:'AI', t:'Anthropic Courses', url:'https://github.com/anthropics/courses', type:'كورسات مجانية', lang:'EN', lvl:'مبتدئ → متوسط', days:[6],
     why:'كورسات Anthropic الرسمية: أساسيات الـ API، والـ Prompting، والـ Tool use.', read:'Anthropic API fundamentals ← Tool use.'},
    {c:'AI', t:'OpenAI: Prompt engineering guide', url:'https://platform.openai.com/docs/guides/prompt-engineering', type:'توثيق رسمي', lang:'EN', lvl:'مبتدئ → متوسط', days:[6],
     why:'نصايح Prompting من OpenAI، ومفيدة لو بتستخدم موديلات OpenAI في n8n.', read:'الصفحة كلها.'},
    {c:'AI', t:'Prompt Engineering Guide', url:'https://www.promptingguide.ai/', type:'دليل مجاني', lang:'EN', lvl:'مبتدئ → متقدم', days:[6],
     why:'دليل مجتمعي شامل لكل تقنيات الـ Prompting والـ Agents والـ RAG.', read:'Introduction و Prompting Techniques.'},
    {c:'AI', t:'Hugging Face LLM Course', url:'https://huggingface.co/learn/llm-course', type:'كورس مجاني', lang:'EN', lvl:'متوسط → متقدم', days:[],
     why:'لو حابب تفهم الموديلات من جوه: Transformers وTokenizers والـ Fine-tuning.', read:'بعد الـ 12 أسبوع: الفصل 1.'},
    {c:'AI', t:'Google Machine Learning Crash Course', url:'https://developers.google.com/machine-learning/crash-course', type:'كورس مجاني', lang:'EN', lvl:'متوسط', days:[],
     why:'أساسيات تعلم الآلة من Google بفيديوهات وتمارين تفاعلية.', read:'بعد الـ 12 أسبوع، لو حابب تتعمق.'},
    // Arabic
    ...
    {c:'عربي', t:'أكاديمية حسوب: مقالات البرمجة', url:'https://academy.hsoub.com/programming/', type:'مقالات', lang:'عربي', lvl:'كل المستويات', days:[],
     why:'آلاف المقالات والدروس المترجمة والمكتوبة بالعربي في كل لغات البرمجة.', read:'دوّر على موضوع اليوم بالعربي بعد ما تقراه بالإنجليزي.'},
    {c:'عربي', t:'Elzero Web School', url:'https://www.youtube.com/@ElzeroWebSchool', type:'فيديوهات', lang:'عربي', lvl:'مبتدئ → متوسط', days:[],
     why:'من أشهر القنوات العربية: كورسات كاملة في JavaScript وPython وGit وHTML/CSS.', read:'قايمة JavaScript أو Python: فيديو أو اتنين في اليوم مع أسبوع اللغة.'},
    {c:'عربي', t:'محارة تك (ITI)', url:'https://maharatech.gov.eg/', type:'كورسات مجانية', lang:'عربي', lvl:'مبتدئ → متوسط', days:[],
     why:'منصة معهد تكنولوجيا المعلومات المصري: كورسات برمجة مجانية بالعربي وشهادات.', read:'دوّر على Python أو JavaScript أو Linux.'},
    {c:'عربي', t:'إدراك', url:'https://www.edraak.org/', type:'كورسات مجانية', lang:'عربي', lvl:'مبتدئ', days:[],
     why:'منصة كورسات عربية مجانية، وفيها مسارات برمجة ومهارات رقمية.', read:'قسم التكنولوجيا والبرمجة.'},
    {c:'عربي', t:'سطر', url:'https://satr.codes/', type:'كورسات مجانية', lang:'عربي', lvl:'مبتدئ', days:[],
     why:'منصة عربية مجانية لتعلم البرمجة بمسارات في Python وJavaScript والويب.', read:'مسار Python أو JavaScript للمبتدئين.'}
  ];
